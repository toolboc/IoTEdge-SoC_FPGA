...
void iothub_module()
{
    ...
    {
        printf("Starting Configuration of FPGA device.\r\n");

        const char *fpga_rbf_loader[64] = {"/app/de10nano_fpga_linux_config/fpga_rbf_load"};
        
        int rc = exec_prog(fpga_rbf_loader);
